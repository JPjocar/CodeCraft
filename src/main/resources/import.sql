-- Insertar Tags
INSERT INTO tags (id, name, description, created_at, updated_at) VALUES (1, 'java', 'Java programming', NOW(), NOW()), (2, 'spring', 'Spring Framework', NOW(), NOW()), (3, 'postgresql', 'PostgreSQL Database', NOW(), NOW());
